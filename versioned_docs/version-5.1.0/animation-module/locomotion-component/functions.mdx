...
* `Rotation Method` <Step text="1"/> : The new [rotation method](/docs/animation-module/types#rotation-method).
...
* `Ain Method` <Step text="1"/> : The new [aim method](/docs/animation-module/types#aim-method).
