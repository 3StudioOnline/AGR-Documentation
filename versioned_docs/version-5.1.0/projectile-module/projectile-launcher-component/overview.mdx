...
The `AGR Projectile Launcher` component should be attached to an actor to become
a type of weapon.
...
`ClientScreenSpaceAimCoords` into the world. It is used for [calculating client aim correction](/docs/projectile-module/projectile-launcher-component/functions/aiming#calculate-client-aim-correction).
...
* `Fire Mode` <Step text="1"/> : New [fire mode](/docs/projectile-module/types#fire-mode).
