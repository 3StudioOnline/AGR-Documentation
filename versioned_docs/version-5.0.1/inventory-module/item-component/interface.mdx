...
* `Slot` <Step text="2"/> : Slot into which the item will be equipped.
...
* `Slot` <Step text="2"/> : Slot from which the item will be unequipped.
...
* `Action Type` <Step text="2"/> : [Type of action](/docs/inventory-module/types#item-update-type) how the item will be used.
