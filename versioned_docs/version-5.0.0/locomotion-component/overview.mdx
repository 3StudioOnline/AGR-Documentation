...
`On Rotation Method Updated` event will be called when the `RotationMethod` of
the component changes.

* `Old Rotation Method` <Step text="1"/> : Old actors rotation method.
* `New Rotation Method` <Step text="2"/> : New actors rotation method.

![On Rotation Method Updated](_static/img/overview/on-rotation-method-updated.png)

### On Aim Method Updated

`On Aim Method Updated` event will be called when the `AimMethod` of the component
changes.

* `Old Aim Method` <Step text="1"/> : Old actors aim method.
* `New Aim Method` <Step text="2"/> : New actors aim method.
